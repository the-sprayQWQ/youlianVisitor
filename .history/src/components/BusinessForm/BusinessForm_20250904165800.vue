...
const {
  ...
  {},
  {
    ...
    onSuccess: (res) => {
      // 将上传成功的URL存储到表单中
      form.value.ylfkApplicationPage.carImage = res.url || res.message
...
const {
  ...
  {},
  {
    ...
    onSuccess: (res) => {
      // 将上传成功的URL存储到表单中
      form.value.ylfkApplicationPage.goodsImage = res.url || res.message
...
function deleteCarPhoto() {
  form.value.ylfkApplicationPage.carPhotoUrl = ''
}

function deleteMaterialsPhoto() {
  form.value.ylfkApplicationPage.materialsPhotoUrl = ''
}
