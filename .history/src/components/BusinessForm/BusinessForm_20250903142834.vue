...
function onHasCarChange(e: any) {
  ...
  form.value.isCard = hasCarOption.value[e.detail.value].value
}
...
function onIdTypeChange(index: number, e: any) {
  ...
  form.value.ylfkApplicationUserList[index].cardType = idTypes.value[e.detail.value].value
  ...
  <view>
    <view class="form-section">
      ...
      <view class="grid-2-col">
        ...
        <view v-if="hasCarOption.value === '1'">
