...
const startDate = ref('2025-10-02')
const endDate = ref('2025-10-10')
const applicantCompany = ref('')
  ...
  <view>
    <view class="form-section">
      ...
      <view class="grid-2-col">
        ...
        <view>
          <text v-if="hasCarOption.value === '1'" class="required-label">
            车牌号
          </text>
          <text v-else class="label">车牌号</text>
          <input
            v-model="carNumber"
            class="input"
            type="text"
