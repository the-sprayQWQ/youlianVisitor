...
const list = computed<CustomTabBarItem[]>(() => {
  console.log('当前角色:', Role.value) // 调试信息
  return Role.value === '访客'
    ? [
        {
          text: '首页',
...
onLoad(() => {
  ...
  tabbarStore.setAutoCurIdx(currentRoute, list)
...
onMounted(async () => {
  ...
  console.log(list.value, 'tabbar') // 这时能看到正确的 tabbar
})
