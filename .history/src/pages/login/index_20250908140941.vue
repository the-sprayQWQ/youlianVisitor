      ...
      <view class="phone-auth-popup">
        <view class="popup-header">
          ...
          <view class="close-btn" @click="closePhoneAuth">
            <view i-carbon:close class="h-24px w-24px" />
          </view>
        </view>

        <view class="popup-content">
          <view class="phone-icon">
            <view i-carbon:phone class="h-64px w-64px text-blue-500" />
          </view>
        ...
        <view class="popup-buttons">
          ...
          >
            <view i-carbon:checkmark class="mr-2 h-20px w-20px" />
            授权手机号
          </button>

          <button class="skip-btn" @click="skipPhoneAuth">
            <view i-carbon:skip-forward class="mr-2 h-20px w-20px" />
            暂时跳过
          </button>
        </view>
      </view>
