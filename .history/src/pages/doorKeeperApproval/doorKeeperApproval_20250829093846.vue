<route lang="jso
  components: { DoorKeeperList },nc" type="home"
>
{
  "layout": "tabbar",
...
import { ref } from 'vue'
import DoorKeeperList from '@/components/DoorKeeperList/DoorKeeperList.vue'
...
<template>
  <view class="visitor-management">
    ...
    <view class="visitor-list">
      <door-keeper-list v-for="item in visitorList" :key="item.id" />
    </view>
  </view>
</template>
