...
function toDetail(id: string, applyId: string, applicationName: string) {
  uni.navigateTo({
    url: `/pages/visitorApplication/visitorApplication?id=${id}&applyId=${applyId}&roleType=${roleType.value}&applicationType=${applicationName}&currentNode=${}`,
  })
}
</script>
...
<template>
  <view class="container">
    <!-- 搜索栏 -->
    <view class="search">
      <view class="text-sm text-#9ba1a5"> 申请日期 </view>
      ...
      <view class="text-sm text-#9ba1a5"> 申请单号 </view>
      ...
      <view class="text-sm text-#9ba1a5"> 业务类型 </view>
