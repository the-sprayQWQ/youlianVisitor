      ...
      <view class="recent-application">
        ...
        <view class="record-list">
          ...
          <view
            ...
            :key="item.id"
            class="record-item"
            @click="handleRecordClick(item.id, roleType, item.applicationName, item.applicationCode)"
          >
            ...
            <view class="status-tag pending" :class="item.processType_dictText === '审批中' ? 'pending' : item.processType_dictText === '已通过' ? 'approved' : 'reject'">
