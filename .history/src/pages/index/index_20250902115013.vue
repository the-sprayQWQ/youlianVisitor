...
function handleRecordClick(id: number, applyId?: string) {
    ...
    <scroll-view class="main-content" scroll-y :show-scrollbar="false">
      ...
      <view class="recent-application">
        ...
        <view class="record-list">
          <!-- 记录项1 -->
          <view class="record-item" @click="handleRecordClick(1, '2025080812')">
          ...
          <!-- 记录项2 -->
          <view class="record-item" @click="handleRecordClick(2)">
            <view class="record-content">
              <text class="record-title">学习交流</text>
              <text class="record-info">申请单号：20250808456</text>
              <view class="record-details">
                <text class="record-detail">当前节点：已完成</text>
                <text class="record-detail">审批人：张建国</text>
              </view>
              <text class="record-time">2025-08-08 09:00</text>
            </view>
            <view class="status-tag approved">
              已通过
            </view>
          </view>

          <!-- 记录项3 -->
          <view class="record-item" @click="handleRecordClick(3)">
            <view class="record-content">
              <text class="record-title">分包商员工核验</text>
              <text class="record-info">申请单号：20250807789</text>
              <view class="record-details">
                <text class="record-detail">当前节点：安全部审批</text>
                <text class="record-detail">审批人：陈安全</text>
              </view>
              <text class="record-time">2025-08-07 10:15</text>
            </view>
            <view class="status-tag pending">
              待审批
            </view>
          ...
          <!-- 记录项4 -->
          <view class="record-item" @click="handleRecordClick(4)">
            <view class="record-content">
              <text class="record-title">船东委外员工核验</text>
              <text class="record-info">申请单号：20250807345</text>
              <view class="record-details">
                <text class="record-detail">当前节点：已完成</text>
                <text class="record-detail">审批人：王海东</text>
              </view>
              <text class="record-time">2025-08-07 15:45</text>
            </view>
            <view class="status-tag approved">
              已通过
            </view>
