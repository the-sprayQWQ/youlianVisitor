...
async function getProcessList(isLoadingMore = false) {
  const res = await getYlfkProcessApplication(isLoadingMore ? currentPage.value : 1, pageSize.value, '0', LoginUserId)
...
async function getOkList() {
  const res = await getYlfkProcessApplication(currentPage.value, pageSize.value, '0', LoginUserId)
