...
function handleView(record: any) {
  ...
  // 这里可以跳转到详情页面
  uni.navigateTo({
    url: `/pages/visitorApplication/visitorApplication?applyId=${record.applicationCode}&applicationType=${record.applicationName}&roleType=${roleType.value}&view=${views}`,
  })
}
