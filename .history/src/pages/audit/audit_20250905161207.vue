        ...
        <view class="date-row">
          ...
          >
            <view class="date-picker-wrapper">
              <text class="date-text" :class="{ placeholder: !searchForm.startDate }">
          ...
          >
            <view class="date-picker-wrapper">
              <text class="date-text" :class="{ placeholder: !searchForm.endDate }">
      ...
      <view v-show="activeTab === 'pending'" class="records-container">
        ...
        >
          ...
          <view class="item-content">
            ...
            <view class="visitor-info">
              <text class="info-text">申请类型: {{ record.applicationTypeName }}</text>
            </view>
            <view class="visitor-info">
