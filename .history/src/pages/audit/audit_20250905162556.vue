...
const roleType = userStore.userInfo.userInfo.roles
// 待审批数据
...
async function toApprove(applicationCode: string, roleType: string) {
  console.log(applicationCode, roleType, 'applicationCode', 'roleType')
}
    ...
    <view class="records-list">
      ...
      <view v-show="activeTab === 'pending'" class="records-container">
        <view
          ...
          :key="record.id"
          class="record-item"
          @click="toApprove(record.applicationCode, roleType)"
        >
