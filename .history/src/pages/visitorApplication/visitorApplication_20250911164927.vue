      ...
      <view class="approval-section">
        <view v-if="managerApp" class="approval-item">
          ...
          <label class="approval-checkbox">
            <wd-checkbox v-if="!rejections.manager" v-model="approvals.manager"> 同意入厂 </wd-checkbox>
            <view v-else class="rejection-box">
              <view class="rejection-icon">×</view>
              <text class="rejection-text">已拒绝</text>
            </view>
          </label>
        </view>
        ...
        <view v-if="doorApp" class="approval-item-extra">
          <view style="display: flex; justify-content: space-between">
            ...
            <label class="approval-checkbox">
              <wd-checkbox v-if="!rejections.guard" v-model="approvals.guard"> 已阅 </wd-checkbox>
              <view v-else class="rejection-box">
                <view class="rejection-icon">×</view>
                <text class="rejection-text">已拒绝</text>
              </view>
