...
function onVisitorTypeChange(e: any) {
...
<template>
  <view class="container">
    ...
    <scroll-view class="content" scroll-y>
      <study-form
        v-if="selectedVisitorType.value === '1'"
        :form="form"
        :apply-id="applyId"
      />
      <business-form v-else :apply-id="applyId" />
    </scroll-view>

    <!-- 审批框 -->
    <view v-if="applyId && roleType !== '访客'" class="mb-12 box-border p-3">
    ...
    <FooterBtn
      ...
      @approve="onApprove"
    />
    <submit-btn v-else @submit="submit" />
    <!-- 问号弹窗 -->
