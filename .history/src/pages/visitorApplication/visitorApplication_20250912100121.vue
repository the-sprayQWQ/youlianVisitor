  ...
  <view class="container">
    ...
    <view v-if="applyId" class="mb-12 box-border p-3">
      <view class="approval-section">
        <view v-if="['入厂门卫二维码检验', '部门审核'].includes(currentNode)" class="approval-item">
        ...
        <view v-if="['分管领导审核', '入厂门卫二维码检验'].includes(currentNode) && currentType.value === '1'" class="approval-item">
        ...
        <view v-if="['入厂门卫二维码检验', '门卫审核'].includes(currentNode)" class="approval-item-extra">
