    ...
    const { loading, error, data, progress, run } = useUpload(
      ...
      {},
      {
        ...
        onSuccess: (res) => {
          ...
          form.value.ylfkCheckApplicationPage.checkUsersList[index].insurance = res.message
        },
        onError: (err) => {
          ...
          <view class="employee-list">
            ...
            >
              ...
              <view class="form-row">
                ...
                >
                  <view v-if="!getEmployeeUploader(index).loading.value" class="i-carbon-cloud-upload text-24px text-gray-400" />
                ...
                <view v-else class="insurance-preview">
                  ...
                  <view class="image-overlay">
                    <view class="action-btn delete-btn" @click.stop="deleteInsurance(index)">
                      <view class="i-carbon-close text-16px" />
                    </view>
                    <view class="action-btn reupload-btn" @click.stop="uploadInsurance(index)">
                ...
                <!-- 上传失败提示 -->
                <view v-if="getEmployeeUploader(index).error.value" class="error-tip">
                  <text>上传失败，请重试</text>
                </view>
              </view>
            </view>
