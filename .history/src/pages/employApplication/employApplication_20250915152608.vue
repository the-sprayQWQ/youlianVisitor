  ...
  <view class="container">
    <scroll-view class="content" scroll-y>
      <form>
        ...
        <!-- 审核信息 -->
        <view v-if="applyId && isShow" class="form-section">
          <text class="section-title">审核信息</text>

          <!-- 部门经理审核 -->
          <view v-if="['归口管理部门经理室审核'].includes(currentNode)" class="approval-card">
          ...
          <!-- 人资部审核 -->
          <view v-if="['人资部行政部审核'].includes(currentNode)" class="approval-card">
          ...
          <!-- 门卫入厂审核 -->
          <view v-if="['门卫入厂审批'].includes(currentNode)" class="approval-card">
          ...
          <view v-if="['门卫离厂审批'].includes(currentNode)" class="approval-card">
