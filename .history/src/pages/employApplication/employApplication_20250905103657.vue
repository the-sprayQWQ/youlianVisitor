...
function onToolsChange(e: any) {
  form.value.ylfkCheckApplicationPage.hasTools = e.detail.value
}
      ...
      <form @submit="submitForm">
        ...
        <view class="form-section">
          ...
          <view class="form-row switch-row">
            ...
            <switch
              :checked="
                form.ylfkCheckApplicationPage.checkHaveGoodsList.hasTools
              "
              color="#3B82F6"
          ...
          <view
            v-if="form.ylfkCheckApplicationPage.checkHaveGoodsList.hasTools"
            class="tools-info"
          >
            <view
