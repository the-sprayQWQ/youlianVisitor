  ...
  if (e.applyId) {
    ...
    if (e.roleType === '访客') {
      ...
      if (e.view === 'true') {
        ...
        disable.value = false // 关键修复：允许审批操作
        isShow.value = true
      }
    }
    else {
    ...
    >
      <form>
        ...
        <view v-if="applyId" class="form-section">
          ...
          >
            ...
            <label class="approval-checkbox">
              <wd-checkbox
                ...
                :disabled="disable || isNodeApproved('归口管理部门经理室审核')"
              >
                我已确认信息无误
              </wd-checkbox>
            </label>
          ...
          <!-- 人资部审核 -->
          <view
            v-if="shouldShowApprovalNode(['门卫入厂审批', '人资部行政部审核'])"
            class="approval-card"
          ...
          >
            ...
            <label class="approval-checkbox">
              <checkbox
                ...
                :disabled="disable || isNodeApproved('人资部行政部审核')"
                color="#3B82F6"
