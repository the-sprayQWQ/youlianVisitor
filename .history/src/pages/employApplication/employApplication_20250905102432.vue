...
function onToolsChange(e: any) {
  form.value.ylfkCheckApplicationPage.checkHaveGoodsList.hasTools = e.detail.value
}
...
function onToolExitChange(index: number, e: any) {
  form.value.ylfkCheckApplicationPage.checkHaveGoodsList[index].isLeave = e.detail.value
}
      ...
      <form @submit="submitForm">
        ...
        <view class="form-section">
          ...
          <view class="form-grid">
            ...
            <view class="form-row">
              ...
              <input v-model="form.ylfkCheckApplicationPage.deptName" type="text" placeholder="请输入单位名称" class="form-input">
            </view>

            <!-- 申请人姓名 -->
            <view class="form-row">
              <text class="form-label">申请人姓名 <text class="required">*</text></text>
              <input v-model="form.ylfkCheckApplicationPage.user" type="text" placeholder="请输入申请人姓名" class="form-input">
            </view>
          </view>
          ...
          <view class="form-grid">
            ...
            <view class="form-row">
              ...
              <input v-model="form.ylfkCheckApplicationPage.idCard" type="text" placeholder="请输入身份证号" class="form-input">
            </view>

            <!-- 联系电话 -->
            <view class="form-row">
              <text class="form-label">联系电话 <text class="required">*</text></text>
              <input v-model="form.ylfkCheckApplicationPage.phone" type="tel" placeholder="请输入联系电话" class="form-input">
            </view>
          </view>
          ...
          <view class="form-row">
            ...
            <input v-model="form.ylfkCheckApplicationPage.allUsers" type="number" placeholder="请输入总人数" min="1" class="form-input">
          </view>
        </view>
        ...
        <view class="form-section">
          ...
          <view class="form-row switch-row">
            ...
            <switch :checked="form.ylfkCheckApplicationPage.isCar" color="#3B82F6" @change="onVehicleChange" />
          </view>

          <view v-if="form.ylfkCheckApplicationPage.isCar" class="vehicle-info">
            <view v-for="(plate, index) in licenseInfo" :key="plate" class="license-plate-item">
              <input v-model="plate" type="text" placeholder="请输入车牌号" class="form-input flex-1">
        ...
        <view class="form-section">
          ...
          <view class="form-row switch-row">
            ...
            <switch :checked="form.ylfkCheckApplicationPage.checkHaveGoodsList.hasTools" color="#3B82F6" @change="onToolsChange" />
          </view>

          <view v-if="form.ylfkCheckApplicationPage.checkHaveGoodsList.hasTools" class="tools-info">
            <view v-for="(tool, index) in form.ylfkCheckApplicationPage.checkHaveGoodsList" :key="index" class="tool-item">
              ...
              <view class="form-row">
                ...
                <input v-model="tool.toolName" type="text" placeholder="请输入工具/物资名称" class="form-input">
              </view>

              <view class="form-row">
                <text class="form-label">数量 <text class="required">*</text></text>
                <input v-model="tool.num" type="number" placeholder="请输入数量" min="1" class="form-input">
              </view>

              <view class="form-row switch-row">
                <text class="form-label">是否离厂</text>
                <switch :checked="tool.isLeave" color="#3B82F6" @change="(e) => onToolExitChange(index, e)" />
              </view>
            </view>
