import type { IApplicationList, IProcessList, IRoleInfo } from '@/api/types/role'
 ...
 * 获取待审批与已审批列表
 */
export function getYlfkProcessApplication(recordStatus: string, currentRecordUser: string) {
  return http.get<IProcessList>('/processApplication/processApplication/listApproval', { pageNo: 1, pageSize: 10, recordStatus, currentRecordUser })
}
