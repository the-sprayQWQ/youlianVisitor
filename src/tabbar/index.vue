...
const roles = userStore.roleType
...
const list = computed(() => {
  if (roles === '访客') {
    ...
    return [
      {
        text: '审批',
        pagePath: '/pages/doorKeeperApproval/doorKeeperApproval',
        iconType: 'unocss',
        icon: 'i-carbon:align-box-top-left',
      },
      // {
      //   text: '访客记录',
      //   pagePath: '/pages/visitorRecord/visitorRecord',
      //   iconType: 'unocss',
...
onLoad(async () => {
  ...
  // 添加角色检查，避免在登录页面或角色未初始化时设置错误的tabbar
  // if (currentRoute.includes('login') || !userStore.roleType) {
  //   console.log('登录页面或角色未初始化，跳过tabbar设置')
  //   return
  // }
