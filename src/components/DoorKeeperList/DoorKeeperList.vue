...
const emit = defineEmits(['toApproval'])
...
function toApproval(applyId: string, applicationType: string, currentNode: string) {
  console.log(applicationType, 'applicationType')
  emit('toApproval', applyId, applicationType, currentNode)
}
</script>
...
<template>
  <view
    ...
    @click="toApproval(item.applicationCode, item.applicationName, item.currentName)"
  >
    <!-- 申请单号和状态 -->
